                            ...
                            <div class="col-md-12">
                                <div class="page-title-inner">
									<div id="breadcrumb" class="breadcrumb margin-bottom-10">
                                        ...
                                        <span class="current">Nos médiathèques</span>
                                    </div>
													...
													<div class="blog-inner">
														...
														<div class="blog-details">
															<div class="blog-title">
																<h4 class="margin-bottom-10"><a href="{{route('mediatheque.show', $data->slug)}}" class="blog-name">{{ Str::limit($data->titre, 50)}}</a></h4>
															</div>
															...
															<div class="post-desc mt-2">
																<div class="blog-link">
																	<a href="{{route('mediatheque.show', $data->slug)}}" class="link font-w-500">Lire la suite</a>
																</div>
															</div>
														</div>
													</div>
